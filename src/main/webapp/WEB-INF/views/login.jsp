...
<br>
<form action="customer_list.html">
<table width=1200 class=search>
  ...
  <tr>
    ...
    <td width=600><input type=text name="LOGIN_ID" size="30" maxlength="40"></td>
  </tr>
  <tr>
    <td width=600 align="right"></td>
    <td width=600 align="right"></td>
  ...
  <tr>
    ...
    <td width=600><input type=password name="LOGIN_PASSWORD" size="30" maxlength="40"></td>
  </tr>
  <tr>
    <td width=600 align="right"></td>
    <td width=600 align="right"></td>
