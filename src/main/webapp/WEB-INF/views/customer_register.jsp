...
function registerCustomer(){
   if( confirm('上記内容で登録してもよろしいですか？') ) {
        document.main.action="/registerCustomer";
		...
		<form name="main">
			...
			<table border=1 width=1000>
				...
				<tr class=hiro3>
					...
					<td align="left">15点(大手メーカーで一部上場企業), 10点(自社若しくは親会社が一部上場企業),
						5点(上記以外に応じて)</td>
				</tr>
				<tr class=hiro3>
					<td width=200 align="center">事業内容</td>
					<td width=100><u>25</u>点/30点</td>
					<td align="left">30点(知名度も高く、シェアが広い自社パッケージ、自社製品の開発),
						20点(上記ではないが自社パッケージ、自社製品の開発、大手メーカーから一括請負), 15点(大手メーカーから一括請負している),
						10点(上記以外に応じて)</td>
				</tr>
				<tr class=hiro3>
					<td width=200 align="center">商流</td>
					<td width=100><u>20</u>点/20点</td>
					<td align="left">20点(エンド), 15点(上記ではないが、商流が浅い(1回面談等)),
						10点(商流がある(2回面談まで))</td>
				</tr>
			</table>
			<br>
			<table border=1 width=1000>
				...
				<tr class=hiro3>
					...
					<td width=800><input type="checkbox" name="programing_skill"
						...
						name="programing_skill" value="2">Java若手 <input
						...
						name="programing_skill" value="4096" checked="checked">C(制御)
				...
				<tr class=hiro3>
					...
					<td width=800><input type="checkbox" name="tester_skill"
						value="1">テスター <input type="checkbox" name="tester_skill"
						value="2">検証 <input type="checkbox" name="tester_skill"
						value="4">ヘルプデスク <input type="checkbox"
						name="tester_skill" value="8" checked="checked">運用監視(24日365h)
						<input type="checkbox" name="tester_skill" value="16"
						checked="checked">システム運用 <input type="checkbox"
						name="tester_skill" value="32">基盤構築 <input type="checkbox"
						name="tester_skill" value="64">サーバー構築 <input
						type="checkbox" name="tester_skill" value="128">サーバー運用 <input
						type="checkbox" name="tester_skill" value="256">ネットワーク構築 <input
						type="checkbox" name="tester_skill" value="512">ネットワーク運用 <input
						type="checkbox" name="tester_skill" value="1024">PMO <input
						type="checkbox" name="tester_skill" value="2048">ドキュメント作成
					</td>
				</tr>
			</table>
			<br>
			...
			<table width=1000>
				<tr>
					<td width=1000 align="center"><input type=button value="登録"
						onclick="registerCustomer()"></td>
				</tr>
				</form>
				<tr>
